...
GTDLL_API GT_ScrewXYP( long EndX, long EndY, long R, short Dir, long ScrewPitch);
GTDLL_API GT_SetCutFllw(unsigned long CutPulse, long CutInitPulse);
GTDLL_API GT_SetCutStrtPos(long CutStartPos,short CutDir);
GTDLL_API GT_DisCutFllw(void);
